...
<html>
	...
	<head>
		...
		<title>Customer Representative Questions!</title>
	</head>

	<body>
		<center>
			<font size = "13" color = "0e5938" >All Questions! </font>
		</center>
			...
			<table border="2">
   			...
   			<%
   				try{
					...
					//Check for username
					String temp = "SELECT * FROM Question";		
   			...
   			%>
						...
						<td><%=question %></td>
						<td>
							<form method="post" action="CustRepQuestionsView.jsp">
