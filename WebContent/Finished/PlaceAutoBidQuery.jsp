...
<html>
	...
	<%	
		try{
			...
			float old_amount = -1;
			String temp = "SELECT B.*, A.dateClosing, A.minimum_increase FROM Auction A, AutoBid B WHERE B.auctionID = A.auctionID";
			...
			if(!badInput){
				...
				String temp1 = "INSERT INTO `AutoBid`(`amount`, `bidder`, `time_of_bid`, `auctionID`)" + " VALUES(?, ?, ?, ?)";
